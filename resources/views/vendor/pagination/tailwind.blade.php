@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="lg:container lg:mx-auto flex justify-center max-w-screen-sm">
        <div class="flex justify-center flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span class="relative  items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md">
