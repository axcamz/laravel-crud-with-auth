<nav class="bg-black">
    <div class="flex flex-col lg:flex-row px-2 py-2 lg:py-4 lg:px-0 lg:container lg:mx-auto">
        <div class="flex  items-center justify-between">
            <div class="font-bold text-xl lg:text-3xl text-white">Diary.</div>
            <button class="lg:hidden focus:outline-none trigger">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"  viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" />
                </svg>
            </button>
        </div>
        <div class="lg:flex items-center w-full justify-end lg:mt-0 mt-2 text-white nav-link hidden">
            <div class="flex lg:flex-row flex-col">
                <div class="lg:ml-5"><a href="">home</a></div>
                <div class="lg:ml-5 mb-3 lg:mb-0"><a href="">posts</a></div>
